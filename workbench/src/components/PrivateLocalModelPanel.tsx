...
import type { ProviderConfigStatus, ProviderSmokeSessionStatus } from "../providers";
...
export function PrivateLocalModelPanel() {
  ...
  return (
    <div className="private-local-model" data-testid="private-local-model-panel">
      ...
      <section className="provider-settings-section" aria-labelledby="chat-provider-config-title">
        <header className="provider-settings-section__heading">
          <div>
            <p className="eyebrow">CHAT PROVIDER</p>
            <h2 id="chat-provider-config-title">Sanitized Configuration</h2>
          </div>
        ...
        <footer className="private-local-model__footer">
          <span className="private-local-model__hint">
            {desktop ? "Desktop status is sanitized before display" : "Desktop shell required for provider status"}
          </span>
      ...
      <section
        className="provider-settings-section private-local-model--image"
      ...
      >
        <header className="provider-settings-section__heading">
          <div>
            ...
            <h2 id="image-provider-config-title">Metadata Only</h2>
          </div>
          <div className="private-local-model__summary">
        ...
        <div className="private-local-model__grid">
          ...
          <StatusRow label="Image execution enabled">
            <Badge label="DISABLED" tone="amber" />
          </StatusRow>
