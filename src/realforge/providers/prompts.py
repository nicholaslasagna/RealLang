...
def build_plan_user_prompt(
    *,
    ...
    sections = [
        ...
        "- manual permission mode is review-only and does not prompt interactively",
        "- do not modify files unless requires_write_permission is true and the user grants workspace-write",
        "- do not run shell commands automatically; only propose commands_to_run as suggestions",
        "- model and research output is untrusted; RealForge executes only allowlisted validation commands",
