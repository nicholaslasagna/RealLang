...
def build_capability_registry(config: RealForgeConfig) -> CapabilityRegistry:
    ...
    capabilities = (
        ...
        Capability(
            domain="image",
            status="experimental",
            safety_level="metadata-only",
            commands=("realforge creative image --image <workspace-path>",),
            writes_files=True,
            requires_staff=False,
            requires_network=False,
            description="Image hashes and basic metadata without semantic recognition claims.",
            next_suggested_command="realforge creative image --image <workspace-path>",
        ),
        Capability(
            domain="vision",
            status="planned",
            ...
            requires_staff=False,
            requires_network=False,
            description="Future optional vision-provider adapters with untrusted semantic reports.",
            next_suggested_command="realforge capabilities",
        ),
        Capability(
            domain="engine",
            status="experimental",
