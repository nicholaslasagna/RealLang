    ...
    capabilities = (
        ...
        Capability(
            ...
            commands=(
                ...
                "realforge engine pipeline --path <project> --task <task>",
                "realforge unreal import-plan --path <project> --task <task>",
            ),
            writes_files=True,
            requires_staff=False,
            requires_network=False,
            description="Engine scans and approval-gated pipeline/import planning without project mutation.",
        ...
        Capability(
            ...
            safety_level="planning-only",
            commands=(
                "realforge creative asset --task <task>",
                "realforge asset pipeline --task <task>",
                "realforge blender asset-plan --task <task>",
            ),
            writes_files=True,
            requires_staff=False,
            requires_network=False,
            description="Asset briefs and DCC/engine pipeline plans; no binary asset generation.",
            next_suggested_command='realforge asset pipeline --task "describe an asset workflow"',
        ),
        Capability(
            domain="eval",
            status="available",
